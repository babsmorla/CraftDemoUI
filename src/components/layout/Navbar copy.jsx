      ...
      <div className="md:hidden fixed w-full z-50 bg-white shadow-md">
        ...
        {isMenuOpen && (
          <div className="bg-white shadow-lg absolute w-full">
            ...
            <NavLink to="/artisan" className={({isActive}) => 
              `block py-3 px-6 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'}`}
              onClick={() => setIsMenuOpen(false)}>
            ...
            <div className="border-t py-3 px-6">
              ...
              <p className="text-center mt-2 text-gray-600">
                ...
                <Link to="/signup" className="text-blue-600 ml-1" onClick={() => setIsMenuOpen(false)}>
                  Sign Up
                </Link>
              </p>
            </div>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              {currentUser ? (
                <div className="flex items-center space-x-4">
                  <Link to="/artisan" className="bg-blue-600 text-white px-5 py-2 rounded-md hover:bg-blue-700 font-medium">
                    Dashboard
                  </Link>
                  <button 
                    onClick={logout}
                ...
                <>
                  <Link to="/login" className="text-gray-700 hover:text-blue-600 font-medium hidden lg:block">
                    Login
                  </Link>
                  <Link to="/signup" className="bg-blue-600 text-white px-5 py-2 rounded-md hover:bg-blue-700 font-medium">
                    Sign Up
                  </Link>
                </>
              )}
