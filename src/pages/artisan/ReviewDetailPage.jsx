...
function ReviewDetailPage() {
  ...
  const homeowner = users.find(u => u.id === review?.userId);
  const artisan = artisans.find(a => a.id === review?.artisanId);

  if (!review) {
    return (
      <div className="max-w-6xl mx-auto px-4 py-8 text-center">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Review Not Found</h2>
        <button
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="border border-gray-200 rounded-lg p-4">
              <h3 className="font-medium text-gray-800 mb-3">Homeowner Information</h3>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xs text-gray-500">
                    Member since {new Date(homeowner?.joinedDate).getFullYear()}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <h3 className="font-medium text-gray-800 mb-3">Artisan Information</h3>
              <div className="flex items-center">
                <div className="bg-gray-200 border-2 border-dashed rounded-xl w-16 h-16" />
                <div className="ml-4">
          ...
          <div className="mb-8">
            ...
            {review.flagged && (
              <div className="mt-4 bg-red-50 p-4 rounded-lg border border-red-100">
                <h4 className="font-medium text-red-800 mb-1">Flagged Reason</h4>
                <p className="text-red-700">{review.flaggedReason || "This review has been flagged by the system"}</p>
              </div>
            )}
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <label className="flex items-center space-x-3 p-4 border border-gray-300 rounded-lg cursor-pointer has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50">
                  ...
                  <div>
                    ...
                    <span className="block text-sm text-gray-500">Publish this review</span>
                  </div>
                </label>
                ...
                <label className="flex items-center space-x-3 p-4 border border-gray-300 rounded-lg cursor-pointer has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50">
                  ...
                  <div>
                    ...
                    <span className="block text-sm text-gray-500">Remove this review</span>
                  </div>
                </label>
                ...
                <label className="flex items-center space-x-3 p-4 border border-gray-300 rounded-lg cursor-pointer has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50">
                  ...
                  />
                  <div>
                    <span className="block text-sm font-medium text-gray-700">Keep Pending</span>
                    <span className="block text-sm text-gray-500">No change</span>
                  </div>
                </label>
              </div>
              {errors.action && (
