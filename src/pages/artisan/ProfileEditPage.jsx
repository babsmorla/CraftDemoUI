...
function ProfileEditPage() {
  ...
  const formattedSpecialties = artisanProfile.specialties.map((specialty, index) => ({
    id: index.toString(),
    value: specialty
  }));
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="md:w-2/3">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2 font-medium">Craft/Skill</label>
                    <input
                      type="text"
                      {...register("craft")}
                      className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2 font-medium">Hourly Rate (GHS)</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        {...register("hourlyRate", { 
                          ...
                          min: { value: 1, message: "Rate must be at least GHS 1" }
                        })}
                        className={`pl-12 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent ${errors.hourlyRate ? 'border-red-500' : ''}`}
                      />
                      {errors.hourlyRate && (
            ...
            <div className="mt-8">
              <div className="flex justify-between items-center mb-4">
                <label className="block text-gray-700 font-medium text-lg">Portfolio Gallery</label>
