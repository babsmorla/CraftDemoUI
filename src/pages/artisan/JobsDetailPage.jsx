  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <h2 className="text-lg font-semibold text-gray-700 mb-2">Homeowner Info</h2>
      ...
      {job.images && job.images.length > 0 && (
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-gray-700 mb-3">Job Photos</h2>
      ...
      <div className="border-t pt-4">
        ...
        <div className="flex items-center">
          <span className={`px-3 py-1 rounded-full text-sm font-medium ${
            ...
            job.status === 'declined' ? 'bg-red-100 text-red-800' :
          ...
          {job.declineReason && (
            <div className="ml-4 text-sm text-gray-600">
              <span className="font-medium">Decline Reason:</span> {job.declineReason}
            </div>
          )}
        </div>
      </div>
      ...
      {showDeclineForm && (
        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
          <h3 className="font-medium text-gray-700 mb-2">Reason for Declining</h3>
          <textarea
            value={declineReason}
