        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">123 Independence Ave, Accra, Ghana</p>
              </div>
            </div>
            <div className="flex items-start">
          ...
          <div className="mt-8">
            ...
            <div className="space-y-3">
              <div>
                <h4 className="font-medium">How do I report a problem with an artisan?</h4>
                <p className="text-gray-600 text-sm">Use the 'Report Profile' button on the artisan's profile page.</p>
              </div>
              <div>
                <h4 className="font-medium">How long does verification take?</h4>
                <p className="text-gray-600 text-sm">Typically 1-2 business days after submitting required documents.</p>
              </div>
              <div>
                <h4 className="font-medium">Is there a fee for using CraftConnect?</h4>
                <p className="text-gray-600 text-sm">No, it's free for homeowners to find artisans. Artisans pay a small commission on completed jobs.</p>
              </div>
            </div>
          </div>
        </div>
