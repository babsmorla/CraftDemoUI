    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {days.map(day => {
            const availability = artisan.availability[day.key];
            return (
                    ...
                    {artisan.specialties.map((service, index) => (
                      ...
                      >
                        ...
                        <p className="mt-2 font-semibold">
                          Starting at ${artisan.hourlyRate}/hr
                        </p>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="flex-grow">
                    {[5, 4, 3, 2, 1].map((rating) => (
                      <div key={rating} className="flex items-center mb-1">
                        <span className="w-16 text-right mr-2">
                          {rating} stars
                        </span>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex text-2xl text-gray-300">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <i
                          key={star}
                          className="fas fa-star hover:text-amber-400 cursor-pointer"
                        ></i>
                      ))}
                    </div>
                  </div>
              ...
              <div>
                          ...
                          <tr key={index}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-500">
                                Professional {service.toLowerCase()} service
                              </div>
                            </td>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600">
                    <li>
                      Prices are estimates and may vary based on project
                      complexity
                    </li>
